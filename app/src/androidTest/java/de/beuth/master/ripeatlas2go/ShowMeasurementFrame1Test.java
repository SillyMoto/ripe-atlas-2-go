...
public class ShowMeasurementFrame1Test {
    ...
    public void onAttachTest() throws Throwable {
        ...
        assertTrue("Fragment frame1 is not added", f.isAdded());
        assertNotNull("Fragment frame1 hasn't create View after adding", f.getView());
    }
    ...
    public void destroyFragment() throws Throwable {
        ...
        assertNull("Fragment frame1 returned non-null from getView after removal", f.getView());
    }
